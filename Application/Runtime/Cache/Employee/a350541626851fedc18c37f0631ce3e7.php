			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form id="MessageForm" class="form-horizontal" role="form" method="post" action="/OA/index.php/Employee/FillEmployee/addEmployeeMsg" onsubmit="return checkMessage(this)">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-102" class="col-xs-10 col-sm-5" name="phone"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<!--<div class="col-sm-9">-->
											<!--<select name="department_id">-->
												...
												<!--<option value="2">人力行政部</option>-->
												<!--<option value="3">财务部</option>-->
												<!--<option value="4">研发部</option>-->
												<!--<option value="5">用户体验部</option>-->
										...
										<div class="col-sm-9" >
											<select name="department_id">
												<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dept): $mod = ($i % 2 );++$i;?><option value="<?php echo ($dept["department_id"]); ?>"><?php echo ($dept["dept_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
...
<![endif]-->
		...
		<script>
			function checkMessage(MessageForm) {
			    if(MessageForm.name.value == "") {
			        alert("姓名不能为空");
			        return false;
				} else if(MessageForm.gender.value == "") {
			        alert("性别不能为空");
			        return false;
				} else if(MessageForm.birthday.value == "") {
			        alert("出生日期不能为空");
			        return false;
				} else if(MessageForm.phone.value == "") {
			        alert("手机号码不能为空");
			        return false;
				} else if(!(/^1[34578]\d{9}$/.test(MessageForm.phone.value))) {
                    alert("手机号格式不正确");
                    return false;
                } else if(MessageForm.entry_time.value == "") {
			        alert("入职时间不能为空");
			        return false;
				} else {
			        return true;
