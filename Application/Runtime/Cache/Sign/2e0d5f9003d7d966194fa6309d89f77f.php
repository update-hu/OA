			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">个人签到列表</h3>

								<div class="row">
									<div class="col-md-6">
										<form class="form-search" action="/OA/index.php/Sign/SignList/showOneSignList" method="get">
											日期 &nbsp;&nbsp;<input  type="date" class="input-medium search-query" name="time" value="<?php echo ($sign["time"]); ?>">
											         <input  type="date" class="input-medium search-query" name="time2" value="<?php echo ($sign["time2"]); ?>">
