					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/OA/index.php/Employee/EmployeeList/editEmployeePosition">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<select name="position" >
												<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><option value="<?php echo ($position["title"]); ?>" ><?php echo ($position["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-9">
											<input id="employeeinput" type="hidden" name="employee_id" >
										</div>
									</div>
