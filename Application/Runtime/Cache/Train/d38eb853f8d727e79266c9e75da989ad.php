					...
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-md-6">
										<form class="form-search" action="/OA/index.php/Train/TrainList/showTrainList" method="get">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$train): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="green" href="/OA/index.php/Train/TrainList/checkTrain?train_id=<?php echo ($train["train_id"]); ?>">
