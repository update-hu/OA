			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<form method="post" action="/OA/index.php/Log/LogList/editLog" >
							<div class="row">
								<div class="col-xs-12">
									<div>
									<span>
										<h4 class="header green clearfix" style="text-align: center">日志标题:<input type="text" name="log_name" value="<?php echo ($log["log_name"]); ?>"></h4>
									</span>
									</div>

									<div class="wysiwyg-editor" id="editor1"><?php echo ($log["content"]); ?></div>
