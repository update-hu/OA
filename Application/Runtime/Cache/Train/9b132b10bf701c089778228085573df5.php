										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$train): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="blue" href="/OA/index.php/Train/List/showTrain?train_id=<?php echo ($train["train_id"]); ?>">
														<i class="icon-zoom-in bigger-130"></i>
													</a>

													<a class="green" href="/OA/index.php/Train/List/showEditTrain?train_id=<?php echo ($train["train_id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Train/List/deleteTrain?train_id=<?php echo ($train["train_id"]); ?>">
