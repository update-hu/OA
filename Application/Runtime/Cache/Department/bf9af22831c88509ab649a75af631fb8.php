					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="MessageForm" class="form-horizontal" role="form" method="post" action="/OA/index.php/Department/FillDepartment/addDepartment" onsubmit="return checkMessage(this)">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 部门名称 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="dept_name"/>
										</div>
									</div>
...
<![endif]-->
		...
		<script>
			function checkMessage(MessageForm) {
			    if(MessageForm.dept_name.value == "") {
			        alert("部门名称不能为空");
			        return false;
				} else {
			        return true;
