					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="MessageForm" class="form-horizontal" role="form" method="post" action="/OA/index.php/Employee/ChangeAcc/changeAccount" onsubmit="return checkMessage(this)">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 用户名 </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="emp_name" placeholder="3-15位字母或数字不能以0开头" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-2" class="col-xs-10 col-sm-5" name="password" placeholder="6-12位数字或者字母"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" id="form-field-3" class="col-xs-10 col-sm-5" name="repassword"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-4" class="col-xs-10 col-sm-5" name="email" />
										</div>
									</div>
...
<![endif]-->
		...
		<script>
			function checkMessage(MessageForm) {
                //检测用户名格式
                var emp_namereg = /^[a-zA-Z1-9]{1}[a-zA-Z0-9]{2,14}$/;
                var emp_name = document.getElementById("form-field-1").value;
                //检测密码格式
                var passwordreg = /^[a-zA-Z0-9]{6,12}$/;
                var password = document.getElementById("form-field-2").value;
                var repassword = document.getElementById("form-field-3").value;
                //检测邮箱格式
                //var emailreg = /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/;
                var emailreg = /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/;
                var email = document.getElementById("form-field-4").value;
                if(emp_name == "") {
                    alert("用户名不能为空");
                    return false;
				} else if(password == "") {
                    ...
                    alert("邮箱不能为空");
                    return false;
				} else if(!emp_namereg.test(emp_name)) {
                    alert("用户名格式不正确");
                    return false;
