			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<form method="post" action="/OA/index.php/Train/FillTrain/addTrain" >
							<div class="row">
								<div class="col-xs-12">
									<div>
									<span>
										<h4 class="header green clearfix" style="text-align: center">培训标题:<input type="text" name="train_name"></h4>
									</span>
									</div>

									<div>
										<span>
											<h4 class="header green clearfix" style="text-align: center">培训目的:<input type="text" name="purpose" ></h4>
										</span>
									</div>

									<div>
										<span>
											<h4 class="header green clearfix" style="text-align: center">培训开始时间:<input type="date" name="start_time" ></h4>
										</span>
										<span>
											<h4 class="header green clearfix" style="text-align: center">培训结束时间:<input type="date" name="end_time" ></h4>
										</span>
									</div>
							...
							<div class="clearfix form-actions" >
								<div class="col-md-offset-3 col-md-9">
									<button class="btn btn-info" type="input" onclick="getDiv()">
