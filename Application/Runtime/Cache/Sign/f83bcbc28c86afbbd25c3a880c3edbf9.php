			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">签到列表</h3>

								<div class="row">
									<div class="col-md-6">
										<form class="form-search" action="/OA/index.php/Sign/SignList/showSignList" method="get">
											姓名 &nbsp;&nbsp;<input type="text" class="input-medium search-query" name="name" value="<?php echo ($sign["name"]); ?>">&nbsp;&nbsp;&nbsp;&nbsp;
											日期 &nbsp;&nbsp;<input  type="date" class="input-medium search-query" name="time" value="<?php echo ($sign["time"]); ?>">
											         <input  id="time2"  type="date" class="input-medium search-query" name="time2" value="<?php echo ($sign["time2"]); ?>">
								...
								<div class="table-responsive">
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sign): $mod = ($i % 2 );++$i;?><tr>

											<td><?php echo ($sign["name"]); ?></td>
											<td><?php echo ($sign["start_time"]); ?></td>
											<td><?php echo ($sign["end_time"]); ?></td>

											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

													<a class="red" href="/OA/index.php/Sign/SignList/deleteSign?sign_id=<?php echo ($sign["sign_id"]); ?>" onclick="DeleteCheck()">
