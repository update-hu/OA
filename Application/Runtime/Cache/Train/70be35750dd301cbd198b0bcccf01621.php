			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">培训列表</h3>

								<div class="row">
									<div class="col-md-6">
										<form class="form-search" action="/OA/index.php/Train/TrainList/showOneTrainList" method="get">
											培训名称 &nbsp;&nbsp;<input type="text" class="input-medium search-query" name="train_name" value="<?php echo ($train["name"]); ?>">
								...
								<div class="table-responsive">
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$train): $mod = ($i % 2 );++$i;?><tr>

											<td>
												<a href="#"><?php echo ($train["train_name"]); ?></a>
											</td>
											<td><?php echo ($train["purpose"]); ?></td>
											<td><?php echo ($train["check"]); ?></td>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="blue" href="/OA/index.php/Train/TrainList/showTrain?train_id=<?php echo ($train["train_id"]); ?>">
														<i class="icon-zoom-in bigger-130"></i>
													</a>

													<a class="green" href="/OA/index.php/Train/TrainList/showEditTrain?train_id=<?php echo ($train["train_id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Train/TrainList/deleteTrain?train_id=<?php echo ($train["train_id"]); ?>" onclick="DeleteCheck()">
