					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/OA/index.php/Log/List/editLog">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" > 日志名称 </label>
										<div class="col-sm-9">
											<input type="text" name="log_name" value="<?php echo ($list["log_name"]); ?>" />
											<input id="loginput" type="hidden" name="log_id" value="<?php echo ($list["log_id"]); ?>" >
										</div>
									</div>
