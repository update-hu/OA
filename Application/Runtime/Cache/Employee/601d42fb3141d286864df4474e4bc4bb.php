							...
							<div class="col-xs-12">
								...
								<div class="table-responsive">
									...
									<form class="form-search">
										姓名 &nbsp;&nbsp;<input type="text" class="input-medium search-query">
										<button type="submit" class="btn btn-xs">Search</button>
									</form>

									<form class="form-search">
										部门 &nbsp;&nbsp;<input type="text" class="input-medium search-query">
										<button type="submit" class="btn btn-xs">Search</button>
									</form>
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$emp): $mod = ($i % 2 );++$i;?><tr>
											...
											<td class="hidden-480">
												<span class="label label-sm label-warning"><?php echo ($emp["status"]); ?></span>
											</td>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="green" href="/OA/index.php/Employee/List/editEmployee?employee_id=<?php echo ($emp["employee_id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Employee/List/deleteEmployee?employee_id=<?php echo ($emp["employee_id"]); ?>">
