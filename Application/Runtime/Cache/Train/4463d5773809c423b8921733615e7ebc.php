					...
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row" >
									<div style="font-size: 30px;">总经理审核</div>
									<div class="col-xs-12" >

										<form method="post" action="/OA/index.php/Train/TrainList/checkTrain" >
											<input name="check" type="hidden" value="审批完成">
											<input id="inputid" type="hidden" name="train_id" >
										...
										<form method="post" action="/OA/index.php/Train/TrainList/checkTrain" >
											<input id="inputid2" type="hidden" name="train_id">
											<input type="hidden" name="check" value="审核不通过" >
											<button class="btn btn-app btn-warning" type="submit">
												<i class="icon-undo bigger-230"></i>
												审核不通过
											</button>
...
<script>
    function sTime() {
        ...
        var day = addZero(dateTime.getDay() + 19 );
        //alert(month + " " + day);
        document.getElementById("stime").value = dateTime.getFullYear() + "-" + month + "-" + day + " " + dateTime.getHours() + ":" + dateTime.getMinutes() + ":" + dateTime.getSeconds();
    }
    function addZero(x) {
        if(x < 10) {
            return "0" + x;
    ...
    window.setInterval(sTime, 1000);
</script>

<script>
    function eTime() {
        var dateTime = new Date();
        var month = addZero(dateTime.getMonth());
        var day = addZero(dateTime.getDay());
        document.getElementById("etime").value = dateTime.getFullYear() + "-" + month + "-" + day + " " + dateTime.getHours() + ":" + dateTime.getMinutes() + ":" + dateTime.getSeconds();
    }
    function addZero(x) {
        if(x < 10) {
            return "0" + x;
