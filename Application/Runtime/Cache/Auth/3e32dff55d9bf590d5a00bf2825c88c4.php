							...
							<div class="col-xs-12">
								...
								<div class="table-responsive">
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($role["title"]); ?></td>

											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

													<a class="green" href="/OA/index.php/Auth/RoleList/showRoleAuth?id=<?php echo ($role["id"]); ?>">
														<i class="icon-plus bigger-130"></i>
													</a>

													<a class="green" href="/OA/index.php/Auth/RoleList/showEditRole?id=<?php echo ($role["id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Auth/RoleList/deleteRole?id=<?php echo ($role["id"]); ?>" onclick="DeleteCheck()">
