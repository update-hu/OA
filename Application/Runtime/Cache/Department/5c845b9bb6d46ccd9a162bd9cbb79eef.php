								...
								<div class="table-responsive">
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$emp): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($emp["department_id"]); ?></td>
											<td>
												<a href="#"><?php echo ($emp["dept_name"]); ?></a>
											</td>
											<td><?php echo ($emp["department"]["num"]); ?></td>

											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

													<a class="green" href="/OA/index.php/Department/List/editDepartment?department_id=<?php echo ($emp["department_id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Department/List/deleteDepartment?department_id=<?php echo ($emp["department_id"]); ?>">
