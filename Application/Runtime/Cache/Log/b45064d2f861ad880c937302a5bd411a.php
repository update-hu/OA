					...
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-md-6">
										<form class="form-search" action="/OA/index.php/Log/LogList/showOneLogList" method="get">
											日志名称 &nbsp;&nbsp;<input type="text" class="input-medium search-query" name="log_name" value="<?php echo ($log["name"]); ?>">
											日期 &nbsp;&nbsp;    <input  type="date" class="input-medium search-query" name="time" value="<?php echo ($log["time"]); ?>">
											             <input  type="date" class="input-medium search-query" name="time2" value="<?php echo ($log["time2"]); ?>">
										...
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="blue" href="/OA/index.php/Log/LogList/showLog?log_id=<?php echo ($log["log_id"]); ?>">
														<i class="icon-zoom-in bigger-130"></i>
													</a>

													<a class="green" href="/OA/index.php/Log/LogList/showEditLog?log_id=<?php echo ($log["log_id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Log/LogList/deleteLog?log_id=<?php echo ($log["log_id"]); ?>" onclick="DeleteCheck()">
