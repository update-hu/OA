			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">请假列表</h3>

								<div class="row">
									<div class="col-md-6">
										<form class="form-search" action="/OA/index.php/Sign/LeaveList/showOneLeaveList" method="get">
											请假标题 &nbsp;&nbsp;<input type="text" class="input-medium search-query" name="leave_name" value="<?php echo ($leave["name"]); ?>">
								...
								<div class="table-responsive">
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$leave): $mod = ($i % 2 );++$i;?><tr>

												<td><?php echo ($leave["leave_name"]); ?></td>
												<td><?php echo ($leave["check"]); ?></td>
												<td><?php echo ($leave["long"]); ?></td>
												<td><?php echo ($leave["start_time"]); ?></td>
												<td><?php echo ($leave["end_time"]); ?></td>

												<td>
													<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

														<a class="blue" href="/OA/index.php/Sign/LeaveList/showLeave?leave_id=<?php echo ($leave["leave_id"]); ?>">
															<i class="icon-zoom-in bigger-130"></i>
														</a>

														<a class="green" href="/OA/index.php/Sign/LeaveList/editLeave?leave_id=<?php echo ($leave["leave_id"]); ?>">
															<i class="icon-pencil bigger-130"></i>
														</a>

														<a class="red" href="/OA/index.php/Sign/LeaveList/deleteLeave?leave_id=<?php echo ($leave["leave_id"]); ?>" onclick="DeleteCheck()">
