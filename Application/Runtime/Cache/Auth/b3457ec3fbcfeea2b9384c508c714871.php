					...
					<ul class="nav nav-list">
						...
						<li class="active open">
							...
							<ul class="submenu">
								...
								<li>
									<a href="/OA/index.php/Role/RoleList/showRoleList">
										<i class="icon-double-angle-right"></i>
										用户组管理
									</a>
								</li>
								<li>
									<a href="/OA/index.php/Role/FillRole/addRole">
										<i class="icon-double-angle-right"></i>
										新增用户组
									</a>
								</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="AuthForm" class="form-horizontal" role="form" method="post" action="/OA/index.php/Auth/AuthList/editAuth" onsubmit="return checkInput(this)">
...
<![endif]-->
		...
		<script>
			function checkInput(AuthForm) {
			    if(AuthForm.title.value == "") {
			        alert("权限名称不能为空")
					return false;
				} else if(AuthForm.name.value == "") {
			        alert("权限不能为空");
			        return false;
				} else {
			        return true;
