			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" method="post" action="/OA/index.php/Department/DepartmentList/editDepartment">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" > 部门名称 </label>
										<div class="col-sm-9">
												<input type="text" name="dept_name" value="<?php echo ($list["dept_name"]); ?>" />
											<input id="departmentinput" type="hidden" name="department_id">
										</div>
									</div>
