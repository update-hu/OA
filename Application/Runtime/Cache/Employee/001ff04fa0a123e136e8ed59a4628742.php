...
<head>
	...
	<link rel="stylesheet" href="/OA/Public/assets/css/mypage.css"  />
			...
			<ul class="nav ace-nav">
				<li class="light-blue">
					...
					<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						<li>
							<a href="/OA/index.php/Login/Login/logout">
								<i class="icon-off"></i>
								注销
							</a>
						</li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-responsive">
									...
									<div class="row">
										<div class="col-md-6">
											<form class="form-search" action="/OA/index.php/Employee/EmployeeList/showEmployeeList" method="get">
												姓名 &nbsp;&nbsp;<input type="text" class="input-medium search-query" name="name" value="<?php echo ($name["name"]); ?>"> &nbsp;&nbsp;

												部门 &nbsp;&nbsp;<select name="department" >
												                      <option><?php echo ($department["department"]); ?></option>
												                      <option></option>
												                      <?php if(is_array($de)): $i = 0; $__LIST__ = $de;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dept): $mod = ($i % 2 );++$i;?><option value="<?php echo ($dept["dept_name"]); ?>" ><?php echo ($dept["dept_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
											                      </select>

												&nbsp;&nbsp;入职时间范围 &nbsp;&nbsp;<input  type="date" class="input-medium search-query" name="entry_time" value="<?php echo ($date["entry_time"]); ?>">
												-<input  type="date" class="input-medium search-query" name="entry_time2" value="<?php echo ($date["entry_time2"]); ?>"> &nbsp;
												<button  type="submit" class="btn btn-xs" >Search</button>
											</form>
										</div>
										<!--<div class="col-md-6">-->
											<!--<form class="form-search" action="/OA/index.php/Employee/EmployeeList/showEmployeeList" method="post">-->
												<!--部门 &nbsp;&nbsp;<input  type="text" class="input-medium search-query" name="department">-->
												<!--<button  type="submit" class="btn btn-xs">Search</button>-->
											<!--</form>-->
										<!--</div>-->
										...
										<!--<div class="col-md-6">-->
											<!--<form class="form-search" action="/OA/index.php/Employee/EmployeeList/showEmployeeList" method="post">-->
												<!--入职时间 &nbsp;&nbsp;<input  type="date" class="input-medium search-query" name="entry_time">-->
												<!--<button  type="submit" class="btn btn-xs">Search</button>-->
											<!--</form>-->
										<!--</div>-->
									</div>
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<th class="hidden-480">离职时间</th>
											<th></th>
										</tr>
										</thead>

										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$emp): $mod = ($i % 2 );++$i;?><tr>
											<td><?php echo ($emp["name"]); ?></td>
											<td><?php echo ($emp["gender"]); ?></td>
											<td class="hidden-480"><?php echo ($emp["phone"]); ?></td>
											<td><?php echo ($emp["email"]); ?></td>
											<td class="hidden-480"><?php echo ($emp["birthday"]); ?></td>
											<td><?php echo ($emp["dept_name"]); ?></td>
											<td><?php echo ($emp["position"]); ?></td>
											<td class="hidden-480">
												<span class="label label-sm label-warning"><?php echo ($emp["condition"]); ?></span>
											</td>
											<td class="hidden-480"><?php echo ($emp["entry_time"]); ?></td>
											<td class="hidden-480"><?php echo ($emp["leave_time"]); ?></td>

											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

													<a class="green" href="/OA/index.php/Employee/EmployeeList/editEmployeePosition?employee_id=<?php echo ($emp["employee_id"]); ?>">
														<i class="icon-plus bigger-130"></i>
													</a>

													<a class="green" href="/OA/index.php/Employee/EmployeeList/editEmployee?employee_id=<?php echo ($emp["employee_id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Employee/EmployeeList/deleteEmployee?employee_id=<?php echo ($emp["employee_id"]); ?>" onclick="DeleteCheck()">
