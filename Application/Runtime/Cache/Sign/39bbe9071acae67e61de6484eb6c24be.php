			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">签到</h3>

								<div class="row" >
									<div style="font-size: 30px;">当前时间</div>
									<div style="font-size: 20px"      id="time" ></div>
									<div class="col-xs-12" >

										<form method="post" action="/OA/index.php/Sign/SignList/addSign" >
											<input id="stime" type="hidden" name="start_time">
										...
										<form method="post" action="/OA/index.php/Sign/SignList/addSign" >
											<input id="etime" type="hidden" name="end_time">
											<button class="btn btn-app btn-success " type="submit">
...
<script>
    function sTime() {
        ...
        var day = addZero(dateTime.getDay() + 26 );
