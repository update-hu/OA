			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">部门列表</h3>

								<div class="row">
									<div class="col-md-6">
										<form class="form-search" action="/OA/index.php/Department/DepartmentList/showDepartmentList" method="get">
											部门名称 &nbsp;&nbsp;<input type="text" class="input-medium search-query" name="dept_name" value="<?php echo ($dept["dept_name"]); ?>">
								...
								<div class="table-responsive">
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$department): $mod = ($i % 2 );++$i;?><tr>

											<td><?php echo ($department["department_id"]); ?></td>
											<td><?php echo ($department["dept_name"]); ?></td>
											<td><?php echo ($department["num"]); ?></td>

											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

													<a class="green" href="/OA/index.php/Department/DepartmentList/editDepartment?department_id=<?php echo ($emp["department_id"]); ?>">
														<i class="icon-pencil bigger-130"></i>
													</a>

													<a class="red" href="/OA/index.php/Department/DepartmentList/deleteDepartment?department_id=<?php echo ($emp["department_id"]); ?>" onclick="DeleteCheck()">
