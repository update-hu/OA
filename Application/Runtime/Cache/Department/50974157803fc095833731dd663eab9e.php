					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form id="MessageForm" class="form-horizontal" role="form" method="post" action="/OA/index.php/Department/FillInfo/addDepartment" onsubmit="return checkMessage(this)">
