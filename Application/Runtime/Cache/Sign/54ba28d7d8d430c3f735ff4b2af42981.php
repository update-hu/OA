											...
											<div class="widget-body">
												<div class="widget-main">
													<p class="alert alert-info" style="text-align: center">
														<?php echo ($list["leave_name"]); ?>
													</p>
													<p class="alert alert-success">
														请假人：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($list["name"]); ?>
													</p>
													<p class="alert alert-success">
														<input type="hidden" value="<?php echo ($list["content"]); ?>" id="in">
													<div id="editor"></div>
													</p>
													<p class="alert alert-success">
														请假时间：<?php echo ($list["start_time"]); ?>----<?php echo ($list["end_time"]); ?>
													</p>
												</div>
											</div>
										</div>
...
<![endif]-->
		...
		<script>
            function changeCode() {
                ...
                document.getElementById("editor").innerHTML = decodeHTML;
            }
