			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form id="MessageForm" class="form-horizontal" role="form" method="post" action="/OA/index.php/Employee/FillInfo/addMessage" onsubmit="return checkMessage(this)">
		...
		<script>
			function checkMessage(MessageForm) {
			    if(MessageForm.name.value == "") {
			        alert("姓名不能为空");
			        return false;
				} else if(MessageForm.birthdate.value == "") {
			        alert("出生日期不能为空");
			        return false;
