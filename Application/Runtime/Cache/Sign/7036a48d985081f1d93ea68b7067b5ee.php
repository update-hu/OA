			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<form method="post" action="/OA/index.php/Sign/LeaveList/editLeave" >
							<div class="row">
								<div class="col-xs-12">
									<div>
									    <span>
										    <h4 class="header green clearfix" style="text-align: center">请假标题:<input type="text" name="leave_name" value="<?php echo ($leave["leave_name"]); ?>"></h4>
									    </span>
									</div>

									<div>
									    <span>
										    <h4 class="header green clearfix" style="text-align: center">开始时间:<input type="date" name="start_time" value="<?php echo ($leave["start_time"]); ?>"></h4>
									    </span>
									</div>

									<div>
									    <span>
										    <h4 class="header green clearfix" style="text-align: center">结束时间:<input type="date" name="end_time" value="<?php echo ($leave["end_time"]); ?>"></h4>
									    </span>
									</div>

									<div class="wysiwyg-editor" id="editor1"><?php echo ($leave["content"]); ?></div>
